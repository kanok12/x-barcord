...
?>
                  <tr>
					...
					<td><center><a href="detaildocAdmin.php?id=<?=$data['trainid'];?>" class="btn btn-info">รายละเอียด</a>
					<a href="updateDocAdmin.php?id=<?=$data['trainid'];?>" class="btn btn-info">แก้ไข</a>
					 <a href="deleteDocDetailAdmin.php?id=<?=$data['trainid'];?>" onClick="return confirm('ยินยันการลบ?');" class="btn btn-danger">ลบ</a></center></td>
                  </tr>
