          ...
          <div class="span12">
            <div class="headnav">
              <ul>
                ...
                <li><a href="logout.php?a">Log out</a></li>
              </ul>
            </div>
            <!-- Signup Modal -->
...
?>
                  <tr>
                    <td><center><?=$data['mid'];?></center></td>
                    <td><center><?=$data['mname'];?></center></td>
                    <td><center><?=$data['muser'];?></center></td>
                    <!-- <td><center><?=$data['mpwd'];?></center></td> -->
                    <!-- <td><center><a href="updateUser.php?id=<?=$data['mid'];?>" class="btn btn-info">แก้ไข</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="deleteUser.php?id=<?=$data['mid'];?>" onClick="return confirm('ยินยันการลบ?');" class="btn btn-danger">ลบ</a></center></td> -->
                  </tr>
<?php } ?>
                </tbody>
              </table>
