<?php
	...
	if(empty($_SESSION["member_level"] == "admin")){
    ...
    <header>
      <div class="container ">
          ...
          <div class="span12">
            <div class="headnav">
              <ul>
                ...
                <li><a href="docDetailAdmin.php">จำนวนเอกสารภายในองค์กร</a></li>
                <li><a href="userForAdmin.php">รายชื่อสมาชิกภายในองค์กร</a></li>
        ...
        <div class="row">
          <div class="span4">
            <div class="logo">
              <a href="indexAdmin.php"><img src="images/kkk.jpg" alt=""/></a>
			  </div>
             
            </div>
			<div class="form-group" align="right">
			<label class="col-md-4 control-label" for="textinput">ค้นหารายชื่อสมาชิก</label>
  				<div class="col-md-4">
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                   ...
                   <th><center>ชื่อUsername</center></th>
                   <th><center>รหัสสมาชิก</center></th>
                   <th><center>ชื่อแผนก</center></th>
...
?>
                  <tr>
                    <td><center><?=$data['member_id'];?></center></td>
                    <td><center><?=$data['member_username'];?></center></td>
                    <td><center><?=$data['member_name'];?></center></td>
                    <td><center><?=$data['member_Dev'];?></center></td>
                    <!-- <td><center><?=$data['mpwd'];?></center></td> -->
                    <td><center><a href="insertNT.php" class="btn btn-blue">เพิ่มข้อมูล</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="updateUser.php?id=<?=$data['mid'];?>" class="btn btn-info">แก้ไข</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="deleteUser.php?id=<?=$data['member_id'];?>" onClick="return confirm('ยินยันการลบ?');" class="btn btn-danger">ลบ</a></center></td>
                  </tr>
<?php } ?>
                </tbody>
              </table>
