      ...
      <div class="container ">
        ...
        <div class="row">
          <div class="span4">
            <div class="logo">
              <h1></h1>
            <img src="images/kanok1.png" alt=""/></div>
          </div>
...
วิธีการใช้งานระบบเบื้องต้น</strong></span> คลิก!</h2>
              ...
              <div class="cta floatright">
                <a class="btn btn-large btn-theme btn-rounded" href="https://travel.trueid.net/detail/KjeQ6DzmeYb">Search</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center"><br>
                        ...
                        <p class="text-white-50 mb-4">ยินดีต้อนรับสู่เว็บไซต์ติดตามเอกสารผ่านการสแกน QR-Code สำหรับผู้ใช้,องค์กร จะใช้บริการของ X-Barcode Tracking ต้องสมัครเข้าใช้งานก่อน คลิกที่ 
Register</p><br>
                        <a class="btn btn-light btn-xl js-scroll-trigger" href="Register.php">Register!</a>
                    </div>
                </div>
            </div>
        </section>
